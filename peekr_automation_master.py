...
1. Lead Generation (Apify) - Monday & Wednesday 7:00 PM UTC (100+ leads per category)
...
class PeekrAutomationMaster:
    ...
    def setup_schedules(self):
        ...
        # Lead generation: Monday & Wednesday at 7:00 PM UTC
        schedule.every().monday.at("19:00").do(self.run_apify_lead_generation)
        schedule.every().wednesday.at("19:00").do(self.run_apify_lead_generation)
        logger.info(f"📊 Scheduled: Lead generation - Monday & Wednesday at 7:00 PM UTC (11:00 PM {timezone_name})")
